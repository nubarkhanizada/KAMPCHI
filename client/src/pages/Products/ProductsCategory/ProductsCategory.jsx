            ...
            <section className="aboutProductCategorySection">
                <div className="container">
                    <div className="aboutProductCategoryContent">
                        <Link to={'/products'}>Products ﹥</Link><span>{categories && categories.find(selectedCategory => selectedCategory.id == id)?.name}</span>
                        <h1>{categories && categories.find(selectedCategory => selectedCategory.id == id)?.name}</h1>
                    </div>
                </div>
